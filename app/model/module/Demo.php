...
class Demo extends Connection{
    ...
    public function breakdownByMonth($params){
        ...
        $sql=
        " SELECT ROUND(CAST(DMBTR AS FLOAT64), 2) AS ammount, '".$params['enterprise']."' AS enterprise, '".$params['account']."' AS account,  BUKRS as sapSociety, CAST(SUBSTR(BUDAT,7,2) AS INT64) AS documentDate".
        " FROM ".
